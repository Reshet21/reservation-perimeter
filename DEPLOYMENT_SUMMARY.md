...
|----------|-------------------------------|-----------|
| **PerimeterProfiles** | `0bce2fd11a67dedada3c2a38a182b640c4252132bc8171f1b17bf3dc4ae3aca9::0bce2fd11a67dedada3c2a38a182b640c4252132bc8171f1b17bf3dc4ae3aca9` | `ae538c41…` |
...
> Старые адреса (86ca… — ~10k тестовых, 3901… — ~500) заброшены: код менялся
> (привязка кошелька, облако) → адреса менялись. Вытащить оттуда деньги нельзя
> (у кода нет вывода) — faucet-деньги тестнета, не критично.
