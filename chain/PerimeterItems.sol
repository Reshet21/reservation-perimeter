...
/**
 * PerimeterItems — он-чейн предметы и рынок игры Reservation: Perimeter
 * для блокчейна Acki Nacki (Shellnet).
 *
 * Модель:
 *  - предметы взаимозаменяемы внутри типа (как стек на складе):
 ...
 *    свободная торговля между игроками, как барахолка.
 */
contract PerimeterItems {
